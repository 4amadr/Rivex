...
def payload_dados_monetarios(data, viewstate):
    ...
    return {
        "frmCdrDid0800": "frmCdrDid0800",
        "frmCdrDid0800:panelDados": "tabFilter",
        "frmCdrDid0800:datefromInputDate": data,
        "frmCdrDid0800:datefromInputCurrentDate": mes_ano,
        "frmCdrDid0800:datetoInputDate": data,
        "frmCdrDid0800:datetoInputCurrentDate": mes_ano,
